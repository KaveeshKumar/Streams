...
public class AssignmentQ4 {
    ...
    public static void main(String[] args) {
        // Adding few Traders
        Trader t1 = new Trader("Hari", "Bangalore");
        Trader t2 = new Trader("kaveesh", "Pune");
        Trader t3 = new Trader("Suresh", "Delhi");
        Trader t4 = new Trader("Arun", "Bhubaneswar");
        Trader t5 = new Trader("harish", "Pune");
        Trader t6 = new Trader("Pranav", "Indore");
