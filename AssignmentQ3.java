...
public class AssignmentQ3 {
    ...
    public static void main(String[] args) {
        ...
        t.add(new Trader("Hari", "Bangalore"));
        t.add(new Trader("kaveesh", "Pune"));
        t.add(new Trader("Suresh", "Delhi"));
        t.add(new Trader("Arun", "Bhubaneswar"));
        t.add(new Trader("harish", "Pune"));
        t.add(new Trader("Pranav", "Indore"));
